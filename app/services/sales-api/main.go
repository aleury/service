...
import (
	...
	"github.com/aleury/service/foundation/keystore"
...
func run(log *zap.SugaredLogger) error {
	...
	log.Infow("startup", "status", "initializing database suppoort", "host", cfg.DB.Host)
	...
	go func() {
		if err := http.ListenAndServe(cfg.Web.DebugHost, debug.Mux(cfg.Build, log, db)); err != nil {
